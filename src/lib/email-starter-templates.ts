...
<!-- Header -->
<tr>
<td style="background:linear-gradient(135deg,#1A2B47 0%,#0f1a2e 100%);padding:32px 40px;text-align:center;">
...
const h1 = 'style="margin:0 0 16px;font-size:24px;font-weight:700;color:#1A2B47;line-height:1.3;"';
...
<td style="background-color:#f4f7fa;border-radius:8px;padding:20px;">
  <table role="presentation" cellpadding="0" cellspacing="0">
    ...
    <tr><td style="font-size:15px;font-weight:600;color:#1A2B47;padding-bottom:12px;">{{planName}}</td></tr>
...
<td style="background:linear-gradient(135deg,#FFF7ED 0%,#FEF3C7 100%);border-radius:8px;padding:24px;border-left:4px solid #FF6B00;">
  <h2 style="margin:0 0 8px;font-size:18px;font-weight:700;color:#1A2B47;">{{featureName}}</h2>
...
<td style="border:1px solid #e5e7eb;border-radius:8px;overflow:hidden;">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td style="padding:16px 20px;font-size:15px;color:#1A2B47;border-top:1px solid #e5e7eb;">{{planDescription}}</td>
      <td style="padding:16px 20px;font-size:15px;color:#1A2B47;border-top:1px solid #e5e7eb;text-align:right;">{{amount}}</td>
    </tr>
    <tr style="background-color:#f9fafb;">
    ...
    <tr>
      <td style="padding:16px 20px;font-size:16px;font-weight:700;color:#1A2B47;border-top:2px solid #e5e7eb;">Total</td>
