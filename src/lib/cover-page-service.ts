...
function normalizeCoverPageResponse(data: any): CoverPageSettings {
  ...
  return {
    ...
    gradientStartColor: extendedSettings.gradientStartColor || DEFAULT_COVER_PAGE.gradientStartColor || '#181B22',
    ...
    titleColor: extendedSettings.titleColor || DEFAULT_COVER_PAGE.titleColor || '#181B22',
