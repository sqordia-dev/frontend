...
export function AIStudioConfigPage() {
  ...
  const t = {
    ...
    subtitle: language === 'fr'
      ? 'Configurez les fournisseurs IA pour la génération de plans d\'affaires'
    ...
    fallbackProvidersDesc: language === 'fr'
      ? 'Utilisés si le fournisseur principal échoue (dans l\'ordre)'
    ...
    sectionOverridesDesc: language === 'fr'
      ? 'Définir un fournisseur IA spécifique pour certaines sections'
      : 'Set a specific AI provider for certain sections',
    useDefault: language === 'fr' ? 'Utiliser par défaut' : 'Use Default',
    ...
    configured: language === 'fr' ? 'Configuré' : 'Configured',
    notConfigured: language === 'fr' ? 'Non configuré' : 'Not configured',
    apiKey: language === 'fr' ? 'Clé API' : 'API Key',
    model: language === 'fr' ? 'Modèle' : 'Model',
    success: language === 'fr' ? 'Configuration enregistrée avec succès!' : 'Configuration saved successfully!',
  };
