...
export default function FinalCTA() {
  ...
  return (
    <section ref={sectionRef} className="relative py-40 overflow-hidden bg-[#181B22]">
      {/* Background decorative elements - animated gradient */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 right-10 w-96 h-96 rounded-full mix-blend-multiply filter blur-3xl opacity-40 animate-blob bg-[#181B22]/50"></div>
        <div className="absolute top-40 left-10 w-96 h-96 rounded-full mix-blend-multiply filter blur-3xl opacity-40 animate-blob animation-delay-2000 bg-[#181B22]/50"></div>
        <div className="absolute -bottom-8 left-1/2 w-96 h-96 rounded-full mix-blend-multiply filter blur-3xl opacity-40 animate-blob animation-delay-4000 bg-[#181B22]/50"></div>
      </div>
