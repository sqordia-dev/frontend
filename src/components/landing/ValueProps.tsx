      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          {valueProps.map((prop, index) => (
            <article
              key={index}
              className="slide-up-element group relative rounded-2xl p-6 md:p-8 border-2 transition-all duration-500 hover:shadow-2xl hover:-translate-y-2"
              style={{
            ...
            >
              ...
              {/* Content */}
              <h3
                className="text-xl md:text-2xl font-bold mb-3 group-hover:text-[#FF6B00] dark:group-hover:text-[#FDBA74] transition-colors"
                style={{ color: isDark ? '#FFFFFF' : '#1A2B47' }}
              >
                {t(prop.titleKey)}
              </h3>
