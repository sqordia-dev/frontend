...
const allPersonaOptions = [
  ...
  { id: 'consultant' as const, titleKey: 'onboarding.step1.persona.consultant', descKey: 'onboarding.step1.persona.consultant.desc', icon: Briefcase, color: '#181B22', bgLight: 'bg-slate-50', bgDark: 'dark:bg-slate-800/50', comingSoon: true },
