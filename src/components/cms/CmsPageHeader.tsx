...
import { ArrowLeft, Eye, Rocket, ChevronDown, Trash2, History, CheckCircle2 } from 'lucide-react';
...
interface CmsPageHeaderProps {
  ...
  disabled?: boolean;
  /** Special pages (like Questions) use auto-save without draft/publish workflow */
  ...
  return (
    <header className="sticky top-0 z-30 h-14 flex items-center bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 px-4 gap-4">
      ...
      <div className="flex items-center gap-2">
        ...
        {isSpecialPage ? (
          /* Special pages: Show "Changes are Live" indicator */
          ...
          /* Regular CMS pages: Show Preview and Publish buttons */
          <>
            <Button
              variant="outline"
              size="sm"
