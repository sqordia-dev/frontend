...
interface BlogPost {
  ...
  date: string;
  image: string;
  en: BlogPostContentData;
  fr: BlogPostContentData;
}
...
export default function BlogPostContent({ locale, slug }: { locale: string; slug: string }) {
