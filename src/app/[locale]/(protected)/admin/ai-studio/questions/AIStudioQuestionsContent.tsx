...
export default function AIStudioQuestionsContent({ locale }: { locale: string }) {
  ...
  const t = {
    ...
    subtitle: uiLanguage === 'fr'
      ? 'Gerez les prompts IA et conseils d\'expert pour chaque question'
      : 'Manage AI coach prompts and expert tips for each question',
    back: uiLanguage === 'fr' ? 'Retour a AI Studio' : 'Back to AI Studio',
    ...
    selectQuestion: uiLanguage === 'fr' ? 'Selectionnez une question' : 'Select a question',
    noPrompt: uiLanguage === 'fr' ? 'Aucun prompt defini' : 'No prompt defined',
    noExpertTip: uiLanguage === 'fr' ? 'Aucun conseil defini' : 'No expert tip defined',
    testPrompt: uiLanguage === 'fr' ? 'Tester le prompt' : 'Test Prompt',
    hideTest: uiLanguage === 'fr' ? 'Masquer le test' : 'Hide Test',
    testAnswer: uiLanguage === 'fr' ? 'Reponse de test' : 'Test Answer',
    testAnswerPlaceholder: uiLanguage === 'fr' ? 'Entrez une reponse pour tester le prompt IA...' : 'Enter an answer to test the AI prompt...',
    runTest: uiLanguage === 'fr' ? 'Executer le test' : 'Run Test',
    ...
    copied: uiLanguage === 'fr' ? 'Copie!' : 'Copied!',
    settings: uiLanguage === 'fr' ? 'Parametres' : 'Settings',
    maxTokens: uiLanguage === 'fr' ? 'Max Tokens' : 'Max Tokens',
    temperature: uiLanguage === 'fr' ? 'Temperature' : 'Temperature',
    provider: uiLanguage === 'fr' ? 'Fournisseur IA' : 'AI Provider',
    noCoachPrompt: uiLanguage === 'fr' ? 'Aucun prompt coach defini pour cette langue' : 'No coach prompt defined for this language',
