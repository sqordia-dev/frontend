...
export default function AIStudioDashboardContent({ locale }: { locale: string }) {
  ...
  const t = {
    ...
    subtitle: language === 'fr'
      ? 'Gerez vos prompts IA, analysez les performances et optimisez la generation de contenu'
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20">
              ...
              <span className="text-sm font-medium text-emerald-400">
                {language === 'fr' ? 'Systeme actif' : 'System Active'}
              </span>
            </div>
          </div>
        </div>
      ...
      <div>
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 p-6">
          ...
          <div className="flex flex-wrap gap-3">
            <Link
              href="/admin/ai-studio/prompts?action=new"
