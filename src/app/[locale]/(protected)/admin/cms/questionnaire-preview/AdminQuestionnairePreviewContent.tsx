...
const STEP_INFO = [
  { number: 1, title: 'Identity & Vision', titleFr: 'Identite et Vision', icon: Target },
  { number: 2, title: 'The Offering', titleFr: "L'Offre", icon: Briefcase },
  { number: 3, title: 'Market Analysis', titleFr: 'Analyse du Marche', icon: TrendingUp },
  { number: 4, title: 'Operations & People', titleFr: 'Operations et Equipe', icon: Users },
...
export default function AdminQuestionnairePreviewContent({ locale }: { locale: string }) {
  ...
  const mobileMainNav: NavItemConfig[] = [
    { name: appLanguage === 'fr' ? 'Apercu' : 'Overview', href: '/admin', icon: LayoutDashboard },
  ...
  const mobileMoreNav: NavItemConfig[] = [
    ...
    { name: appLanguage === 'fr' ? 'Problemes' : 'Issues', href: '/admin/bug-report', icon: ListTodo },
  ];
